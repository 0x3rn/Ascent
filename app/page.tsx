  ...
  return (
    <>
      ...
      <div className="flex flex-col md:flex-row h-dvh md:h-screen overflow-hidden print:block print:h-auto print:overflow-visible">
        <aside className="print:hidden w-full md:w-[440px] md:min-w-[440px] border-r border-zinc-200/50 dark:border-zinc-800/50 bg-white/80 dark:bg-zinc-950/80 backdrop-blur-xl flex flex-col h-full z-10 shadow-[4px_0_24px_-12px_rgba(0,0,0,0.1)]">
          <header className="shrink-0 px-4 md:px-5 py-3 md:py-4 border-b border-zinc-100 dark:border-zinc-800/50 flex items-center justify-between gap-3"><div className="flex items-center gap-2 md:gap-2.5"><div className="h-8 w-8 md:h-9 md:w-9 rounded-xl bg-gradient-to-br from-indigo-500 to-cyan-500 flex items-center justify-center shrink-0 shadow-inner shadow-white/20"><FileText className="h-4 w-4 md:h-4 md:w-4 text-white" /></div><div><h1 className="text-sm md:text-base font-bold text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-cyan-600 dark:from-indigo-400 dark:to-cyan-400 leading-tight">Ascent</h1><p className="text-[10px] md:text-[11px] font-medium text-zinc-500 dark:text-zinc-400 leading-tight">AI Career Toolkit</p></div></div><Button onClick={() => handlePrint()} size="sm" className="gap-1.5 md:gap-2 shrink-0 text-xs h-8 md:h-9 px-3 md:px-4 active:scale-95 transition-all duration-300 shadow-md hover:shadow-lg bg-gradient-to-r from-indigo-600 to-cyan-600 hover:from-indigo-500 hover:to-cyan-500 text-white border-0"><Download className="h-3.5 w-3.5" /><span className="hidden sm:inline font-medium">Download PDF</span><span className="sm:hidden font-medium">PDF</span></Button></header>
          <nav className="shrink-0 flex border-b border-zinc-100 dark:border-zinc-800/50"><button onClick={() => { setBuilderMode("resume"); setActiveTab("personal"); }} className={`flex-1 flex items-center justify-center gap-1.5 px-3 py-3 text-xs font-semibold border-b-2 transition-all duration-200 ${isRes ? "border-indigo-500 text-indigo-600 bg-indigo-50/50 dark:border-indigo-400 dark:text-indigo-400 dark:bg-indigo-950/20" : "border-transparent text-zinc-500 hover:text-zinc-800 hover:bg-zinc-50/50 dark:text-zinc-400 dark:hover:text-zinc-200 dark:hover:bg-zinc-800/30"}`}><FileText className="h-4 w-4" />Resume</button><button onClick={() => { setBuilderMode("cover-letter"); setCoverView("edit"); }} className={`flex-1 flex items-center justify-center gap-1.5 px-3 py-3 text-xs font-semibold border-b-2 transition-all duration-200 ${isCov ? "border-indigo-500 text-indigo-600 bg-indigo-50/50 dark:border-indigo-400 dark:text-indigo-400 dark:bg-indigo-950/20" : "border-transparent text-zinc-500 hover:text-zinc-800 hover:bg-zinc-50/50 dark:text-zinc-400 dark:hover:text-zinc-200 dark:hover:bg-zinc-800/30"}`}><Mail className="h-4 w-4" />Cover Letter</button><button onClick={() => { setBuilderMode("interview"); setCoverView("edit"); }} className={`flex-1 flex items-center justify-center gap-1.5 px-3 py-3 text-xs font-semibold border-b-2 transition-all duration-200 ${isInt ? "border-indigo-500 text-indigo-600 bg-indigo-50/50 dark:border-indigo-400 dark:text-indigo-400 dark:bg-indigo-950/20" : "border-transparent text-zinc-500 hover:text-zinc-800 hover:bg-zinc-50/50 dark:text-zinc-400 dark:hover:text-zinc-200 dark:hover:bg-zinc-800/30"}`}><MessageSquare className="h-4 w-4" />Interview</button></nav>
          {isRes && (<nav className="shrink-0 flex border-b border-zinc-100 dark:border-zinc-800/50 overflow-x-auto no-scrollbar">{tabs.map(t => (<button key={t.id} onClick={() => setActiveTab(t.id)} className={`flex-1 min-w-0 flex items-center justify-center gap-1.5 px-2 md:px-3 py-2.5 md:py-3 text-[11px] md:text-xs font-semibold border-b-2 whitespace-nowrap transition-all duration-200 ${activeTab === t.id ? "border-indigo-500 text-indigo-600 bg-indigo-50/50 dark:border-indigo-400 dark:text-indigo-400 dark:bg-indigo-950/20" : "border-transparent text-zinc-500 hover:text-zinc-800 hover:bg-zinc-50/50 dark:text-zinc-400 dark:hover:text-zinc-200 dark:hover:bg-zinc-800/30"}`}>{"icon" in t && t.icon ? <>{t.icon} </> : null}<span>{t.label}</span></button>))}</nav>)}
        ...
        <main className="hidden md:flex flex-1 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-indigo-50/50 via-zinc-50/50 to-cyan-50/50 dark:from-indigo-950/20 dark:via-zinc-950 dark:to-cyan-950/20 overflow-auto items-start justify-center p-6 shrink-0 print:flex print:bg-white print:p-0 print:overflow-visible print:h-auto print:w-full print:items-start print:justify-start"><div className="flex flex-col items-center gap-4 print:w-full print:gap-0"><div className="flex items-center gap-3 self-start print:hidden rounded-xl border border-white/20 dark:border-white/10 px-3 py-2 shadow-sm bg-white/60 dark:bg-zinc-900/60 backdrop-blur-md ring-1 ring-black/5 dark:ring-white/10"><div className="flex items-center gap-2"><span className="text-[11px] font-semibold text-zinc-600 dark:text-zinc-300">Font</span><select value={themeFont} onChange={e => setThemeFont(e.target.value)} className="text-[11px] font-medium border-0 bg-white/50 dark:bg-zinc-800/50 rounded-md py-1 px-2 text-zinc-900 dark:text-white focus:ring-2 focus:ring-indigo-500 cursor-pointer outline-none transition-shadow" style={{ colorScheme: "light" }}>{FONTS.map(f => <option key={f.value} value={f.value} style={{ color: "#000", backgroundColor: "#fff" }}>{f.label}</option>)}</select></div><div className="w-px h-5 bg-zinc-200 dark:bg-zinc-700" /><div className="flex items-center gap-2"><span className="text-[11px] font-semibold text-zinc-600 dark:text-zinc-300">Color</span><select value={themeAccent} onChange={e => setThemeAccent(e.target.value)} className="text-[11px] font-medium border-0 bg-white/50 dark:bg-zinc-800/50 rounded-md py-1 px-2 text-zinc-900 dark:text-white focus:ring-2 focus:ring-indigo-500 cursor-pointer outline-none transition-shadow" style={{ colorScheme: "light" }}>{COLORS.map(c => <option key={c.value} value={c.value} style={{ color: "#000", backgroundColor: "#fff" }}>{c.label}</option>)}</select></div></div>{isRes ? <div className="origin-top shadow-[0_20px_50px_-12px_rgba(0,0,0,0.15)] ring-1 ring-black/5 print:ring-0 print:shadow-none print:w-full transition-shadow hover:shadow-[0_25px_60px_-12px_rgba(0,0,0,0.2)]">{resumeEl}</div> : isCov ? (<><div className="flex items-center gap-2 self-start print:hidden flex-wrap"><Button onClick={handleCopy} disabled={!coverBody} size="sm" variant="outline" className="gap-1.5 text-xs h-8 bg-white/50 dark:bg-zinc-800/50 backdrop-blur-sm border-white/20 dark:border-white/10 shadow-sm hover:bg-white dark:hover:bg-zinc-700 transition-all">{copied ? <Check className="h-3.5 w-3.5 text-green-600" /> : <Copy className="h-3.5 w-3.5" />}{copied ? "Copied!" : "Copy Text"}</Button><Button onClick={handleShorten} disabled={!coverBody || shortening} size="sm" variant="outline" className="gap-1.5 text-xs h-8 bg-white/50 dark:bg-zinc-800/50 backdrop-blur-sm border-white/20 shadow-sm hover:bg-white transition-all">{shortening ? <Loader2 className="h-3.5 w-3.5 animate-spin" /> : <Scissors className="h-3.5 w-3.5" />}{shortening ? "Shortening..." : "Shorten"}</Button><Button onClick={handleRegenerate} disabled={!coverBody || regenerating} size="sm" variant="outline" className="gap-1.5 text-xs h-8 bg-white/50 dark:bg-zinc-800/50 backdrop-blur-sm border-white/20 shadow-sm hover:bg-white transition-all">{regenerating ? <Loader2 className="h-3.5 w-3.5 animate-spin" /> : <RotateCw className="h-3.5 w-3.5" />}{regenerating ? "Regenerating..." : "Regenerate"}</Button><Button onClick={handleDelete} disabled={!coverBody} size="sm" variant="outline" className="gap-1.5 text-xs h-8 bg-red-50/50 dark:bg-red-950/30 text-red-600 border-red-100 dark:border-red-900/50 hover:bg-red-100 dark:hover:bg-red-900/50 transition-all"><Trash2 className="h-3.5 w-3.5" />Delete</Button></div><div className="origin-top shadow-[0_20px_50px_-12px_rgba(0,0,0,0.15)] ring-1 ring-black/5 print:ring-0 print:shadow-none print:w-full transition-shadow hover:shadow-[0_25px_60px_-12px_rgba(0,0,0,0.2)]">{coverEl}</div></>) : (<><div className="flex items-center gap-2 self-start print:hidden flex-wrap"><Button onClick={handleIntCopy} disabled={!intContent} size="sm" variant="outline" className="gap-1.5 text-xs h-8 bg-white/50 dark:bg-zinc-800/50 backdrop-blur-sm border-white/20 shadow-sm hover:bg-white transition-all">{intCopied ? <Check className="h-3.5 w-3.5 text-green-600" /> : <Copy className="h-3.5 w-3.5" />}{intCopied ? "Copied!" : "Copy"}</Button><Button onClick={handleIntClear} disabled={!intContent} size="sm" variant="outline" className="gap-1.5 text-xs h-8 bg-red-50/50 dark:bg-red-950/30 text-red-600 border-red-100 dark:border-red-900/50 hover:bg-red-100 dark:hover:bg-red-900/50 transition-all"><Trash2 className="h-3.5 w-3.5" />Clear</Button></div><div className="origin-top shadow-[0_20px_50px_-12px_rgba(0,0,0,0.15)] ring-1 ring-black/5 print:ring-0 print:shadow-none print:w-full transition-shadow hover:shadow-[0_25px_60px_-12px_rgba(0,0,0,0.2)]">{intEl}</div></>)}</div></main>
      </div>
    </>
  );
}
