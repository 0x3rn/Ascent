...
export function ResumePreview() {
  ...
  return (
    <div className="w-[210mm] min-h-[297mm] bg-white text-zinc-900 font-[Inter] shadow-2xl print:shadow-none print:w-auto print:h-auto print:min-h-0 print:m-0">
      {/* Inline print style for Safari header/footer suppression */}
      <style type="text/css" media="print">
        {`@page { size: A4; margin: 0mm !important; } body { margin: 0 !important; }`}
      </style>
      ...
      <div className="px-[18mm] py-[16mm] print:px-[18mm] print:py-[16mm]">
        ...
        <header className="text-center mb-4 print:break-after-avoid">
          ...
          {personalInfo.title && (
            <p className="text-[13pt] text-zinc-600 mt-1 font-semibold leading-snug">
              {personalInfo.title}
            </p>
          )}
        ...
        {personalInfo.summary && (
          <section className="mb-3 print:pt-[10mm] print:break-inside-avoid">
            <h2 className="text-[12pt] font-bold leading-snug uppercase tracking-normal text-zinc-800 border-b border-zinc-300 pb-0.5 mb-1.5">
            ...
            {experience.map((exp) => (
              <div key={exp.id} className="mb-2.5 print:break-inside-avoid">
                <div className="flex justify-between items-baseline flex-wrap gap-1">
                  <div>
                    <h3 className="text-[13pt] font-semibold leading-snug text-zinc-900">
                      {exp.role || "Role"}
                      {exp.company && (
                  ...
                  <div className="text-[10pt] text-zinc-500 whitespace-nowrap">
            ...
            {projects.map((proj) => (
              <div key={proj.id} className="mb-2.5 print:break-inside-avoid">
                <div className="flex justify-between items-baseline flex-wrap gap-1">
                  ...
                  {proj.link && (
                    <span className="text-[10pt] text-zinc-500 whitespace-nowrap">{proj.link}</span>
                  )}
                </div>
                {proj.skills && (
